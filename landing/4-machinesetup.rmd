...
If you *don't* log in, you can still use the DHBox by using the username/password combination of `demonstration/demonstration`. **nb** the demo accounts shut down after an hour and will delete all work. (Should there be a problem with our DHBox, you can log into the demo box at [Dhbox.org](http://dhbox.org) but remember the time limit).
